...
Owned-cons reuse is carried as compiler facts:
...
There is no standalone reuse-pruning pass and duplicate owned-cons capability lane.
Codegen reads reusable source objects from
