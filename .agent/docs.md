...
- [physical-capabilities](docs/physical-capabilities.md) — semantic values vs physical capabilities, effect facts (`src/ir_effects.rs`), owned-cons reuse capability lowering, or the pinned allocation floors.
