...
| [docs/destination-passing.md](docs/destination-passing.md) | Destination-passing IR, erased init-token facts, tuple/list/map construction lowering, or typed container field initialization. |
