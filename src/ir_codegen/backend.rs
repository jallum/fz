...
pub(crate) fn register_runtime_symbols(builder: &mut JITBuilder) {
    ...
    builder.symbol("fz_map_from_kv", ir_runtime::fz_map_from_kv as *const u8);
    ...
    builder.symbol("fz_map_put_atom_ref", ir_runtime::fz_map_put_atom_ref as *const u8);
    builder.symbol("fz_op_div_ii_to_float", ir_runtime::fz_op_div_ii_to_float as *const u8);
