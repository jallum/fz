...
pub(crate) fn runtime_import_sig(name: &str) -> Signature {
    ...
    let (params, rets): (&[ir::Type], &[ir::Type]) = match name {
        ...
        "fz_map_put_ref" => (&[I64, I64, I64, I64], &[I64]),
        "fz_map_put_int" => (&[I64, I64, I64, I64], &[I64]),
        "fz_map_put_float" => (&[I64, I64, I64, F64], &[I64]),
        "fz_map_put_atom" => (&[I64, I64, I64, I64], &[I64]),
        "fz_map_put_atom_key_int" => (&[I64, I64, I64, I64], &[I64]),
        "fz_map_put_atom_key_float" => (&[I64, I64, I64, F64], &[I64]),
        "fz_map_put_atom_key_atom" => (&[I64, I64, I64, I64], &[I64]),
        "fz_map_put_int_key_int" => (&[I64, I64, I64, I64], &[I64]),
        "fz_map_put_int_key_float" => (&[I64, I64, I64, F64], &[I64]),
        "fz_map_put_int_key_atom" => (&[I64, I64, I64, I64], &[I64]),
        "fz_map_put_float_key_int" => (&[I64, I64, F64, I64], &[I64]),
        "fz_map_put_float_key_float" => (&[I64, I64, F64, F64], &[I64]),
        "fz_map_put_float_key_atom" => (&[I64, I64, F64, I64], &[I64]),
...
fn declare_map_runtime<M: cranelift_module::Module>(jmod: &mut M) -> Result<MapRefs, CodegenError> {
    Ok(MapRefs {
        map_empty_id: decl_import(jmod, "fz_map_empty")?,
        ...
        map_put_ref_id: decl_import(jmod, "fz_map_put_ref")?,
        map_put_int_id: decl_import(jmod, "fz_map_put_int")?,
        map_put_float_id: decl_import(jmod, "fz_map_put_float")?,
        map_put_atom_id: decl_import(jmod, "fz_map_put_atom")?,
        map_put_atom_key_int_id: decl_import(jmod, "fz_map_put_atom_key_int")?,
        map_put_atom_key_float_id: decl_import(jmod, "fz_map_put_atom_key_float")?,
        map_put_atom_key_atom_id: decl_import(jmod, "fz_map_put_atom_key_atom")?,
        map_put_int_key_int_id: decl_import(jmod, "fz_map_put_int_key_int")?,
        map_put_int_key_float_id: decl_import(jmod, "fz_map_put_int_key_float")?,
        map_put_int_key_atom_id: decl_import(jmod, "fz_map_put_int_key_atom")?,
        map_put_float_key_int_id: decl_import(jmod, "fz_map_put_float_key_int")?,
        map_put_float_key_float_id: decl_import(jmod, "fz_map_put_float_key_float")?,
        map_put_float_key_atom_id: decl_import(jmod, "fz_map_put_float_key_atom")?,
