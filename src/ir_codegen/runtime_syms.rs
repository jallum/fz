...
fn runtime_import_types(name: &str) -> (&'static [ir::Type], &'static [ir::Type]) {
    ...
    // arg/return is a pointer-width-or-narrower word; the signature is just
    // the type list. `decl_import` (JIT/AOT declaration) and
    // `CodegenFn::call_named` (the by-name intrinsic call path) both consult
    // this table.
    let (params, rets): (&[ir::Type], &[ir::Type]) = match name {
        ...
        "fz_list_reuse_or_cons_parts" => (&[I64, I64, I64, I64, I64, I64], &[I64]),
        "fz_list_reuse_or_cons_ref" => (&[I64, I64, I64, I64, I64], &[I64]),
...
pub(crate) fn declare_runtime_symbols<M: ClModule>(jmod: &mut M) -> Result<RuntimeRefs, CodegenError> {
    ...
    Ok(RuntimeRefs {
        ...
        list_reuse_or_cons_ref_id: list.list_reuse_or_cons_ref_id,
...
struct ListRefs {
    ...
    list_reuse_or_cons_ref_id: FuncId,
...
fn declare_list_runtime<M: ClModule>(jmod: &mut M) -> Result<ListRefs, CodegenError> {
    Ok(ListRefs {
        ...
        list_reuse_or_cons_ref_id: decl_import(jmod, "fz_list_reuse_or_cons_ref")?,
...
pub(crate) struct RuntimeRefs {
    pub(crate) halt_implicit_ref_id: FuncId,
    pub(crate) halt_implicit_i64_id: FuncId,
    pub(crate) halt_implicit_f64_id: FuncId,
    pub(crate) halt_implicit_atom_id: FuncId,
    pub(crate) halt_cont_body_strict_id: FuncId,
    pub(crate) halt_cont_body_i64_id: FuncId,
    pub(crate) halt_cont_body_f64_id: FuncId,
    pub(crate) halt_cont_body_atom_id: FuncId,
    pub(crate) alloc_id: FuncId,
    pub(crate) list_cons_any_id: FuncId,
    pub(crate) list_cons_int_id: FuncId,
    pub(crate) list_cons_float_id: FuncId,
    pub(crate) list_cons_atom_id: FuncId,
    pub(crate) list_is_cons_id: FuncId,
    pub(crate) list_head_fallback_id: FuncId,
    ...
    pub(crate) list_reuse_or_cons_ref_id: FuncId,
    pub(crate) mark_published_ref_aliased_id: FuncId,
    pub(crate) alloc_struct_id: FuncId,
    pub(crate) struct_get_field_id: FuncId,
    pub(crate) struct_get_named_field_id: FuncId,
    pub(crate) struct_set_field_ref_id: FuncId,
    pub(crate) struct_set_field_int_id: FuncId,
    pub(crate) struct_set_field_float_id: FuncId,
    pub(crate) struct_set_field_atom_id: FuncId,
    pub(crate) bs_begin_id: FuncId,
    pub(crate) bs_write_ref_id: FuncId,
    pub(crate) bs_finalize_id: FuncId,
    /// Single-shot allocation from a module-baked byte payload.
    pub(crate) alloc_bitstring_const_id: FuncId,
    /// Alloc a ProcBin referencing a static SharedBin in .data.
    pub(crate) alloc_procbin_from_static_id: FuncId,
    /// Noop destructor address relocated into static SharedBins.
    pub(crate) shared_bin_destructor_noop_id: FuncId,
    // Binary/cstring extern marshal helpers. Both have signature
    // `(i64 tagged_heap_bits) -> i64 *const u8` from Cranelift's perspective.
    pub(crate) binary_as_ptr_id: FuncId,
    pub(crate) binary_as_cstring_id: FuncId,
    pub(crate) extern_symbol_addr_id: FuncId,
    pub(crate) extern_var_i64_cstring_i64_i64_to_i64_id: FuncId,
    pub(crate) extern_var_i64_cstring_i64_to_i64_id: FuncId,
    pub(crate) bs_reader_init_ref_id: FuncId,
    pub(crate) bs_read_field_ref_id: FuncId,
    pub(crate) bs_reader_done_ref_id: FuncId,
    pub(crate) map_dest_begin_id: FuncId,
    pub(crate) map_dest_begin_update_id: FuncId,
    pub(crate) map_dest_put_parts_id: FuncId,
    pub(crate) map_dest_put_ref_id: FuncId,
    pub(crate) map_dest_freeze_id: FuncId,
    pub(crate) map_get_ref_id: FuncId,
    pub(crate) map_get_atom_key_ref_id: FuncId,
    pub(crate) map_get_int_key_ref_id: FuncId,
    pub(crate) map_get_float_key_ref_id: FuncId,
    pub(crate) ref_load_int_id: FuncId,
    pub(crate) ref_load_float_id: FuncId,
    pub(crate) ref_load_atom_id: FuncId,
    pub(crate) type_of_id: FuncId,
    pub(crate) unbox_int_id: FuncId,
    pub(crate) unbox_float_id: FuncId,
    pub(crate) unbox_atom_id: FuncId,
    pub(crate) struct_schema_id_ref_id: FuncId,
    pub(crate) truthy_ref_id: FuncId,
    pub(crate) box_int_for_any_id: FuncId,
    ...
    pub(crate) closure_halt_kind_ref_id: FuncId,
    pub(crate) materialize_cont_id: FuncId,
    pub(crate) closure_get_capture_ref_id: FuncId,
    pub(crate) closure_get_capture_i64_id: FuncId,
    pub(crate) closure_get_capture_f64_id: FuncId,
    pub(crate) closure_get_capture_atom_id: FuncId,
    pub(crate) closure_set_capture_ref_id: FuncId,
    pub(crate) closure_set_capture_i64_id: FuncId,
    pub(crate) closure_set_capture_f64_id: FuncId,
    pub(crate) closure_set_capture_atom_id: FuncId,
    /// fz_receive_park_matched FFI entry. Called from the
    /// Term::ReceiveMatched arm in compile_block_terminator.
    pub(crate) receive_park_matched_id: FuncId,
    pub(crate) get_static_closure_id: FuncId,
    pub(crate) get_halt_cont_id: FuncId,
    ...
    pub(crate) yield_mid_flight_report_id: FuncId,
    pub(crate) yield_slow_path_begin_id: FuncId,
}
