...
const DERIVE_RECURSIVE_RATCHET: [(&str, u64, u64, u64, u64); 3] = [
    ...
    ("fixtures2/behavior/enum_predicate_search.fz", 75, 12, 162, 85),
    ...
    ("fixtures2/behavior/enum_take_drop_split.fz", 128, 26, 265, 136),
];
