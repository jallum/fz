    ...
    for (fixture_index, fixture) in TARGET_FIXTURES.into_iter().enumerate() {
        ...
        for (scenario, (name, report)) in SCENARIOS.iter().zip(&reports).enumerate() {
            ...
            assert_eq!(
                ...
                [[228, 0, 0, 9, 155], [603, 0, 0, 64, 392], [1181, 0, 0, 1, 590]][fixture_index][scenario],
...
const DERIVE_RECURSIVE_RATCHET: [(&str, u64, u64, u64, u64); 3] = [
    ...
    ("fixtures2/behavior/enum_take_drop_split.fz", 134, 26, 285, 146),
];
...
fn deriving_recursion_from_call_graph_facts_extracts_each_body_once() {
    for (fixture, evaluations, concluded_nothing, callee_evaluations, callee_blocked) in DERIVE_RECURSIVE_RATCHET {
        ...
        assert_eq!(
            ...
            "{fixture}: DeriveStaticCallees work moved off its measured pin. Full row: {callees:?}"
        );
...
const ANALYSIS_CLAIM_RATCHET: [AnalysisClaimRatchet; 3] = [
    AnalysisClaimRatchet {
        ...
        // fz-5xp.2: 22 -> 21 shift wakes and 121 -> 120 rebased completions.
        // `Enum.to_list/1` reaches a list through a clause typed `[a]`, so the
        ...
        // fz-5xp.2: 212 -> 211 evaluations and 13 -> 12 zero-change outputs.
    ...
    AnalysisClaimRatchet {
        ...
        // at zero.
        activations: lifecycle(248, 248, 0),
        ...
        callsites: lifecycle(429, 439, 10),
