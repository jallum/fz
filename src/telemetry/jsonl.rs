...
impl JsonlBackend {
    ...
    pub fn install(self, telemetry: &ConfiguredTelemetry) {
        ...
        telemetry.attach_raw_event1::<crate::compiler2::pull::PullSessionId, _>(
            ...
            move |name, span_id, parent_span_id, session_id| {
                session_started_backend.handle_raw_event(
                    ...
                    span_id,
                    parent_span_id,
                    crate::metadata! { session_id: session_id.0 },
                );
            },
        );
        ...
        telemetry.attach_raw_event2::<crate::compiler2::pull::ProductKey, crate::compiler2::pull::PullOutcome, _>(
            &["fz", "compiler2", "pull", "product", "evaluated"],
            move |name, span_id, parent_span_id, product, outcome| {
        ...
        telemetry.attach_raw_event3::<
            ...
            crate::compiler2::BackendProgram,
            _,
        >(
            &["fz", "compiler2", "backend_request", "finished"],
            move |name, span_id, parent_span_id, world, root, program| {
