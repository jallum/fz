...
// PICK: make_resource creates resource and dtor fires once on process exit
#[test]
...
// PICK: aliased resource bindings fire destructor exactly once
#[test]
...
// PICK: opaque resource .value accessor returns payload through module boundary
#[test]
