...
pub fn cheney_forward_strict_bits(
    ...
    let addr = bits & !crate::any_value::TAG_MASK;
    if addr == 0 {
        return None;
    }
...
pub fn forward_any_value_ref_root(
    ...
    match value.tag() {
        ...
        tag if tag.is_scalar() => {
            ...
            *value = AnyValueRef::from_scalar_slot(tag, dst as *const u64)
        ...
        tag if tag.is_heap() => {
            ...
            if let Some(new_bits) = cheney_forward_strict_bits(
                ...
                let new_addr = (new_bits & !crate::any_value::TAG_MASK) as *const u8;
...
pub fn cheney_forward_list(
    ...
    if mark_fragment_for_tracing(p, crate::any_value::TAG_LIST, fragments, frag_queue) {
        return p;
    }
...
pub fn cheney_forward_procbin(
    ...
    if mark_fragment_for_tracing(p, crate::any_value::TAG_PROCBIN, fragments, frag_queue) {
        return p;
    }
...
pub fn cheney_forward_resource(
    ...
    if mark_fragment_for_tracing(p, crate::any_value::TAG_RESOURCE, fragments, frag_queue) {
        return p;
    }
...
pub fn copy_to_space_with_confirmed_forwarding(
    ...
    unsafe {
        std::ptr::write(p.add(8) as *mut u64, crate::any_value::TAG_FWD);
    }
