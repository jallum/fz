...
- continuation capture normalization prunes dead reducer-return captures before
  codegen, so those six closures occupy 272 bytes instead of carrying dead state;
