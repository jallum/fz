...
| `item_macro_source/` | source-order item macro returns Fz-shaped function source | jit, interp |
...
| `range_enumerable/` | Range implements Enumerable reduce/count/member?/slice callbacks | jit, interp, aot, repl |
